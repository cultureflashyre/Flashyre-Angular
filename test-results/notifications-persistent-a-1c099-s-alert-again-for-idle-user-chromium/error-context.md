...
- Name: notifications-persistent-alert.spec.ts >> Persistent Notification Alerts & Idle Heartbeat Workflow >> Scenario 4: New request arrival triggers alert again for idle user
- Location: e2e\notifications-persistent-alert.spec.ts:115:7
...
Locator: locator('app-global-notification-bar .superadmin-bar')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('app-global-notification-bar .superadmin-bar')
