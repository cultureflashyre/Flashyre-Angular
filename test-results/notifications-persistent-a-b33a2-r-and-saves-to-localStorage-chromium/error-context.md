...
- Name: notifications-persistent-alert.spec.ts >> Persistent Notification Alerts & Idle Heartbeat Workflow >> Scenario 2: Clicking Notification Bell dismisses toast and top bar and saves to localStorage
- Location: e2e\notifications-persistent-alert.spec.ts:72:7
