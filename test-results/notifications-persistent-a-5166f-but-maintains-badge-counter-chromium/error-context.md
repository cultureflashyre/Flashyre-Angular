...
- Name: notifications-persistent-alert.spec.ts >> Persistent Notification Alerts & Idle Heartbeat Workflow >> Scenario 3: Reloading page keeps alerts suppressed but maintains badge counter
- Location: e2e\notifications-persistent-alert.spec.ts:95:7
...
Locator: locator('app-notification-bell .badge-count')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('app-notification-bell .badge-count')
