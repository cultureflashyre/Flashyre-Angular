...
export class CandidateInputForm {
  @Input()
  jobTitleInputPlaceholder1: string = 'Enter Skills'
  @ContentChild('text6')
  ...
  @Input()
  jobTitleInputPlaceholder5: string = 'Enter Job Location'
  @ContentChild('skillStarText')
  skillStarText: TemplateRef<any>
  @Input()
  jobTitleInputPlaceholder3: string = 'Enter Phone Number'
  ...
  @Input()
  jobTitleInputPlaceholder2: string = 'Enter Client Name'
  @ContentChild('text2')
  text2: TemplateRef<any>
  @ContentChild('selectText2')
  selectText2: TemplateRef<any>
  @Input()
  jobTitleInputPlaceholder4: string = 'Enter Job Location'
  @ContentChild('heading')
  heading: TemplateRef<any>
  @ContentChild('skillStarText1')
  skillStarText1: TemplateRef<any>
  @Input()
  companyNameInputPlaceholder6: string = 'Min Salary'
  @Input()
  rootClassName: string = ''
  @ContentChild('jobTitleText3')
  jobTitleText3: TemplateRef<any>
  @ContentChild('jobTitleText')
  jobTitleText: TemplateRef<any>
  @Input()
  jobTitleInputPlaceholder: string = 'Enter Work Experience'
  @Input()
  ...
  @Input()
  companyNameInputPlaceholder1: string = 'Enter Email'
