...
export class RecruiterWorkflowNavbarComponent {
  ...
  @Input() link1Url: string = 'https://www.teleporthq.io';
  @Input() imageSrc1: string = '/assets/main-logo/logo%20-%20flashyre(1500px)-200h.png';
  @Input() rootClassName: string = '';
  @Input() imageAlt11: string = 'image';

  @ContentChild('text12') text12: TemplateRef<any> | null = null;
  @ContentChild('text1411') text1411: TemplateRef<any> | null = null;
  @ContentChild('text15') text15: TemplateRef<any> | null = null;
  @ContentChild('text31') text31: TemplateRef<any> | null = null;

  @Input() imageSrc4: string =
  ...
  @ContentChild('link4') link4: TemplateRef<any> | null = null;

  @Input() imageAlt1: string = 'image';
